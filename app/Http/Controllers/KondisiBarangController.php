...
class KondisiBarangController extends Controller
{
    ...
    //    $status=StatusProduct::all();
        ...
        $kondisi=Kondisi::all();
        return view('barangs.kondisi', compact('kondisi'));
    }
    ...
    public function create()
    {
        ...
        return view('barangs.addkondisi', compact('kd'));
    }
    ...
    public function edit($id)
    {
        ...
        // $status = StatusProduct::all();
        return view ('barangs.editkondisibarang', compact('kondisi'));
    }
    ...
    {
        $kondisi = Kondisi::with('kondisi')->find($id);
        $kondisi->delete();
        return redirect()->route('kondisibarang.index');
    }

    public function cetak_kondisibarang()
    {
        $kondisi = Kondisi::all();
