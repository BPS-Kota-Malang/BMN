...
class BarangController extends Controller
{
    ...
    {
        $jtersedia = Product::where('id_statusproduct', '=', 1)->count();
        $jdipinjam = Product::where('id_statusproduct', '=', 3)->count();
        $jrusak = Product::where('id_statusproduct', '=', 2)->count();
        $jdiservis = Product::where('id_statusproduct', '=', 5)->count();
        $jhilang = Product::where('id_statusproduct', '=', 4)->count();
