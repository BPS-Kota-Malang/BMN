...
class PinjamBarangController extends Controller
{
    ...
    //tampilan halaman peminjaman pada role "pjbarang"
    ...
    public function create()
    {
        ...
        $barang = Product::where('id_statusproduct', '=',1)->get();
    ...
    public function store(Request $request)
    {
        ...
        BorrowProduct::create([
            ...
            'kondisi_setelahdipinjam'=>$request->kondisi_setelahdipinjam,
    ...
    public function edit($id)
    {
        ...
        $barang = Product::where('id_statusproduct', '=' , 'Tersedia')->get();
        $petugas = User::where('role', '=' , 'pjbarang')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $reqpinjam->tanggal_pengembalian=$request->tanggal_pengembalian;
        $reqpinjam->kondisi_setelahdipinjam=$request->kondisi_setelahdipinjam;
        $reqpinjam->catatan=$request->catatan;
        ...
        if($request->barang_lama!=$reqpinjam->id_product)
        {
            ...
            $baranglama->id_statusproduct='Tersedia';
            $baranglama->save();


        }
        //mengubah status barang baru menjadi diajukan
        $barang->id_statusproduct='Diajukan';
        $barang->save();
    ...
    public function rejected($id)
    {
        ...
        $product->id_statusproduct='Tersedia';
        $product->save();
